<x-admin.layout title="Biblioteca de Media" breadcrumb="Imagens & Ficheiros">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <div class="bg-white rounded-sm border border-admin-border overflow-hidden group hover:border-brand/50 transition duration-200 flex flex-col justify-between"
             x-data="{ copied: false }">
            ...
            <div class="relative aspect-square bg-gray-100 overflow-hidden">
                ...
                <span class="absolute top-2 left-2 text-[10px] font-bold bg-black/60 text-white px-2 py-0.5 rounded-sm backdrop-blur">
            ...
            <div class="p-3 flex-1 flex flex-col justify-between">
                ...
                <div class="flex items-center gap-1 mt-3 pt-2 border-t border-gray-100">
                    <button type="button"
                            ...
                            class="flex-1 text-[11px] font-medium py-1.5 px-2 rounded-sm border border-gray-200 text-gray-600 hover:border-brand hover:text-brand transition flex items-center justify-center gap-1">
                    ...
                    <form action="{{ route('admin.media.destroy') }}" method="POST"
                        ...
                        <button type="submit" class="p-1.5 text-gray-400 hover:text-red-600 rounded-sm hover:bg-red-50 transition" title="Eliminar imagem">
    ...
    @else
    <div class="bg-white rounded-sm border border-admin-border p-12 text-center text-admin-muted">
