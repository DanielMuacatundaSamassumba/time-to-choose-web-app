...
<footer class="bg-[#0f0f0f] text-white mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex gap-4 mt-8">
                    <a href="#" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center
                              hover:bg-[#F45600] transition duration-300">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ url('/') }}"
                            class="text-white/60 hover:text-[#F45600] transition duration-200 text-sm flex items-center gap-2">
            ...
            <div>
                ...
                <ul class="space-y-5">
                    <li class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-white/90 text-sm font-medium">Morada</p>
                    ...
                    <li class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="tel:+244923000000" class="text-white/50 text-sm hover:text-[#F45600] transition">
                                +244 923 000 000
                            </a>
                        </div>
                    </li>
                    <li class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:info@timetochoose.ao"
                                class="text-white/50 text-sm hover:text-[#F45600] transition">
    ...
    <div class="border-t border-white/5  bg-[#DDDDDD]">
        <div class="w-full max-w-7xl mx-auto px-6 lg:px-8 py-6
            ...
            <div class="flex items-center gap-6 text-gray-500 text-sm">
                <a href="#" class="hover:text-[#F45600] transition duration-200">Política de Privacidade</a>
                <a href="#" class="hover:text-[#F45600] transition duration-200">Termos de Utilização</a>
                <a href="#" class="hover:text-[#F45600] transition duration-200">Cookies</a>
            </div>
        </div>
    </div>
